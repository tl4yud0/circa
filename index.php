   ...
   <i class="icon-menu burger-button" id="burger-menu"></i>
                  ...
                  <form  method="post" id="contactform"  enctype="multipart/form-data">
                     <h2 class="contact-title" >Contacto</h2>
                       <div class="container-form">
                             <input class="form-input"  type="text" placeholder="First Name*"    name="name" placeholder="Tu nombre" required>
                       ...
                       <div class="container-button">
                             ...
                             <input name="submit" type="submit" value="Enviar" class="submit-btn btn btn-success" ></div>

                       </div>
                  </form>
                  <h2 class="contact-title thanks" >Gracias!!! nos pondremos en contacto contigo. </h2>
                </div> 
            </article>
        </div>
    </section>
    <footer class="footer">
       ...
       <div class="box--footer-container">
        ...
        <div class="box--footer-container">
           ...
           <div class="footer-images"> 
               <img class="box--footer-colab" src="images/acciones.jpg" alt="" width="130" height="50">
               <img class="box--footer-colab" src="images/acciones.jpg" alt="" width="130" height="50">
               <img class="box--footer-colab" src="images/acciones.jpg" alt="" width="130" height="50">
               <img  class="box--footer-colab"src="images/acciones.jpg" alt="" width="130" height="50">
           </div>
       ...
       <div class="box--footer-container">
           ...
           <div>
               <h5>Teléfonos</h5>
               <p>951 548 31 12 <br>951 197 37 31</p>
               <h5>Correo electrónico</h5>
               <p>contacto.circa@gmail.com</p>
           </div>
           <div>
               <h5>Dirección </h5>
